...
const { getPerformanceReport } = require('./alert_gamas_access');
...
(async () => {
  ...
  try {
    ...
    const targets = [
      {
        url: 'https://sympony.tif3.net/bot-assurance/access',
        sel: '#captureArea',
        name: 'alert-gamas-access.png',
        title: 'Alert Gamas Access',
      },
    ];
